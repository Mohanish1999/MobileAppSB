...
public class MobileCtrl {
	...
	@RequestMapping(method=RequestMethod.PUT,value="/mobile/{imeiNo}")
	public List<Mobile> updateMobile(@PathVariable String oldimeiNo,@RequestBody Mobile m1)
	{
		return mobileService.updateMobile(oldimeiNo,m1);
	}
}
